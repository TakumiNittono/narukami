...
// 通知開封イベントを記録するAPI（認証不要・Service Workerから呼び出し）
export default async function handler(req, res) {
    ...
    const { notification_id, notification_type = 'scheduled', user_id, metadata = {} } = req.body;
    ...
    try {
        ...
        updateNotificationStats(notification_id, 'open').catch(err => {
